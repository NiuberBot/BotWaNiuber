...
/////////////////
const BotName = 'NiuberBot'; 
const instagram = 'Tidak Ada :('; 
const telegram = 'Tidak Ada :('; 
const kapanbotaktif = 'Jam 9-5'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Niuber')
